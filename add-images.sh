...
# Add stock images to Pi blog posts
...
cd /data/data/com.termux/files/home/workspace/pi
...
for file in "$BLOGDIR"/*.html; do
    ...
    # Pi posts have structure: <p style="opacity:0.6;margin-bottom:30px;">Date</p>
    # Insert img tag after that date line
